DigitalVirgo\MTSP\Model\Status
===============
...
### getOperatorCode
    ...
    integer DigitalVirgo\MTSP\Model\Status::getOperatorCode()
...
### setOperatorCode
    ...
    \DigitalVirgo\MTSP\Model\Status DigitalVirgo\MTSP\Model\Status::setOperatorCode(integer $operatorCode)
...
### getStatusCode
    ...
    string DigitalVirgo\MTSP\Model\Status::getStatusCode()
...
### setStatusCode
    ...
    \DigitalVirgo\MTSP\Model\Status DigitalVirgo\MTSP\Model\Status::setStatusCode(string $statusCode)
